...
Built compliant narrative-generation workflows using historical notes, user actions, domain-specific constraints, and validation controls to automate legal documentation while preserving reviewability and enterprise workflow safety.

### Information Extraction for Enterprise CRM — Production NLP

Built an email signature extraction system using named entity recognition to convert unstructured communications into structured CRM data, improving the quality and automation of customer and contact records.

### Agentic Enterprise Workflow Platform — Reference Architecture / Prototype

Designed reference architecture for AI agents operating over enterprise data, APIs, documents, and human approval workflows. Covered context retrieval, permission-aware connectors, tool orchestration, source-backed answers, workflow state, audit trails, evaluation, guardrails, and human-in-the-loop execution for high-value enterprise workflows.

### Enterprise Context & Workflow Intelligence — Architecture R&D

Developed architecture patterns for converting fragmented enterprise knowledge into an operational context layer that supports source-backed answers, role-specific copilots, workflow discovery, approval-aware automation, and measurable business outcomes across functions such as sales, operations, compliance, finance, and service delivery.

---

## Professional Experience

### Intapp — Senior Machine Learning Engineer / AI Architect
